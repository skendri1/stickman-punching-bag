...
public class TimeTrialActivity extends Activity implements Observer{
	...
	public void createGameController() {
		...
		this.gameController = new TimeTrialGameController(this.savedInstanceState, this.timerTextView, this.numberOfPunchesCounterTextView);
	...
	public void update(Observable observable, Object data) {
		...
		Toast.makeText(this, "Timer Finished:\nNumber of Punches: " + this.gameController.getNumberOfPunches(), Toast.LENGTH_LONG).show();
	}
